...
public class Environment {
	...
	public Environment()
	{
		...
		Cube obj = new Cube(new Point3D(0,0,10), new Vector3D(1,0,0), new Vector3D(0,0,1),
				new IntColor(255, 0, 0), 20, .2, 0);
		Cube obj2 = new Cube(new Point3D(13,3,2), new Vector3D(1,0,0), new Vector3D(0,0,1),
				new IntColor(0, 255, 0), 4, .2, 0);
		Sphere sphere = new Sphere(new Point3D(3, 15, 2), 2, new IntColor(0, 0, 255), .2, 0);
		Sphere sphere2 = new Sphere(new Point3D(-6, 15, 4), 4, new IntColor(0x93, 0xdb, 0x70), .2, 0);
		primatives.add(floor);
		primatives.add(obj);
		primatives.add(obj2);
		primatives.add(sphere);
		primatives.add(sphere2);
		camera = new Camera(new Point3D(60, 50, 25), new Vector3D(-3, -2.5, -1.25), new Vector3D(0,0,1),
				40, 40, 2000, 2000);
		rays = camera.getRays();
